        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.navigation_history:
                    //mainIntent = new Intent(HistoryActivity.this, HistoryActivity.class);
                    //.this.startActivity(mainIntent);
                    //HistoryActivity.this.finish();
                    //mTextMessage.setText(R.string.title_UAE);
                    return true;
                case R.id.navigation_UAE:
                    mainIntent = new Intent(HistoryActivity.this, UAEActivity.class);
                    HistoryActivity.this.startActivity(mainIntent);
                    //HistoryActivity.this.finish();
                    //mTextMessage.setText(R.string.title_UAE);
                    return true;
                case R.id.navigation_home:
                    mainIntent = new Intent(HistoryActivity.this, HomeActivity.class);
                    HistoryActivity.this.startActivity(mainIntent);
                    //HistoryActivity.this.finish();
                    return true;
                ...
                case R.id.navigation_Trends:
                    mainIntent = new Intent(HistoryActivity.this, TrendsActivity.class);
                    HistoryActivity.this.startActivity(mainIntent);
                    //HistoryActivity.this.finish();
                    //mTextMessage.setText(R.string.title_UAE);
                    return true;
