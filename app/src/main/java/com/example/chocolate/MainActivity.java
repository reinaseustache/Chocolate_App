...
public class MainActivity extends AppCompatActivity {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.navigation_history:
                    ...
                    mainIntent = new Intent(MainActivity.this, HistoryActivity.class);
                ...
                case R.id.navigation_UAE:
                    mainIntent = new Intent(MainActivity.this, UAEActivity.class);
                    MainActivity.this.startActivity(mainIntent);
                    //MainActivity.this.finish();
                    //mTextMessage.setText(R.string.title_UAE);
                    return true;
                ...
                case R.id.navigation_SA:
                    mainIntent = new Intent(MainActivity.this, SaudiActivity.class);
                    MainActivity.this.startActivity(mainIntent);
                    //MainActivity.this.finish();
                    //mTextMessage.setText(R.string.title_UAE);
                    return true;
                case R.id.navigation_Trends:
                    mainIntent = new Intent(MainActivity.this, TrendsActivity.class);
                    MainActivity.this.startActivity(mainIntent);
                    //MainActivity.this.finish();
                    //mTextMessage.setText(R.string.title_UAE);
                    return true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setTitle("Chocolate In the Middle East");
        BottomNavigationView navView = findViewById(R.id.nav_view);
