...
public class UAEActivity extends AppCompatActivity {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.navigation_history:
                    mainIntent = new Intent(UAEActivity.this, HistoryActivity.class);
                    UAEActivity.this.startActivity(mainIntent);
                    UAEActivity.this.finish();
                    //mTextMessage.setText(R.string.title_UAE);
                    return true;
                case R.id.navigation_UAE:
                    //mainIntent = new Intent(TrendsActivity.this, UAEActivity.class);
                    //TrendsActivity.this.startActivity(mainIntent);
                    //TrendsActivity.this.finish();
                    //mTextMessage.setText(R.string.title_UAE);
                    return true;
                case R.id.navigation_home:
                    mainIntent = new Intent(UAEActivity.this, HomeActivity.class);
                    UAEActivity.this.startActivity(mainIntent);
                    UAEActivity.this.finish();
                    return true;
                case R.id.navigation_SA:
                    mainIntent = new Intent(UAEActivity.this, SaudiActivity.class);
                    UAEActivity.this.startActivity(mainIntent);
                    UAEActivity.this.finish();
                    mTextMessage.setText(R.string.title_UAE);
                    return true;
                case R.id.navigation_Trends:
                    mainIntent = new Intent(UAEActivity.this, TrendsActivity.class);
                    UAEActivity.this.startActivity(mainIntent);
                    UAEActivity.this.finish();
                    mTextMessage.setText(R.string.title_UAE);
                    return true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navView.getMenu().findItem(R.id.navigation_UAE).setChecked(true);
    }
