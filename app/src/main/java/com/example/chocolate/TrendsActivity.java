...
public class TrendsActivity extends AppCompatActivity {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.navigation_history:
                    mainIntent = new Intent(TrendsActivity.this, HistoryActivity.class);
                ...
                case R.id.navigation_home:
                    mainIntent = new Intent(TrendsActivity.this, HomeActivity.class);
                    TrendsActivity.this.startActivity(mainIntent);
                    TrendsActivity.this.finish();
                    return true;
                case R.id.navigation_SA:
                    mainIntent = new Intent(TrendsActivity.this, SaudiActivity.class);
                    TrendsActivity.this.startActivity(mainIntent);
                    TrendsActivity.this.finish();
                    return true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navView.getMenu().findItem(R.id.navigation_Trends).setChecked(true);
    }
