        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.navigation_history:
                    mainIntent = new Intent(HomeActivity.this, HistoryActivity.class);
                    HomeActivity.this.startActivity(mainIntent);
                    //HomeActivity.this.finish();
                    //mTextMessage.setText(R.string.title_UAE);
                    return true;
                case R.id.navigation_UAE:
                    mainIntent = new Intent(HomeActivity.this, UAEActivity.class);
                    HomeActivity.this.startActivity(mainIntent);
                   // HomeActivity.this.finish();
                    //mTextMessage.setText(R.string.title_UAE);
                    return true;
                case R.id.navigation_home:
                    //mainIntent = new Intent(HomeActivity.this, HomeActivity.class);
                    //HomeActivity.this.startActivity(mainIntent);
                    //HomeActivity.this.finish();
                    return true;
                case R.id.navigation_SA:
                    mainIntent = new Intent(HomeActivity.this, SaudiActivity.class);
                    HomeActivity.this.startActivity(mainIntent);
                    //HomeActivity.this.finish();
                    //mTextMessage.setText(R.string.title_UAE);
                    return true;
                case R.id.navigation_Trends:
                    mainIntent = new Intent(HomeActivity.this, TrendsActivity.class);
                    HomeActivity.this.startActivity(mainIntent);
                    //HomeActivity.this.finish();
                    //mTextMessage.setText(R.string.title_UAE);
                    return true;
